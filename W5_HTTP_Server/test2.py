...
class Server:
 ...
 def __init__(self, port = 80):
     ...
     self.port = port
     work_dir = os.path.abspath('C:\\Users\\kvr\\Documents\\Otus-Python\\W5_HTTP_Server\\http-test-suite\\httptest\\')
     self.www_dir = work_dir #'www' # Directory where webpage files are stored
 ...
 def _wait_for_connections(self):
     ...
     while True:
         ...
         if (request_method == 'GET') | (request_method == 'HEAD'):
             ...
             file_requested = os.path.join(self.www_dir, file_requested[1:])
